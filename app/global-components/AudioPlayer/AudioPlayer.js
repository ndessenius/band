...
<Image className="max-w-max absolute -top-16 left-1/2 -translate-x-1/2 rounded-xl max-w-[16rem] lg:max-w-xs opacity-90" src="/cover.svg" width={250} height={250} alt="Album cover" />
